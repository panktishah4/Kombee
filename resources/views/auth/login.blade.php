    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"  id="apiLoginForm">
                        @csrf
...
<script>
    let client_id = "{{ config('services.passport.password_client_id') }}";
    let client_secret = "{{ config('services.passport.password_client_secret') }}"
</script>
